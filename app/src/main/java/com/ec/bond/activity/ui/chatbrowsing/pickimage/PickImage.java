...
public class PickImage extends AppCompatActivity implements View.OnTouchListener {
                    ...
                    case RecyclerView.SCROLL_STATE_DRAGGING:
                        ...
                        if (mScrollbar.getVisibility() != View.VISIBLE) {
                            ...
                            if (!Utility.isViewVisible(mScrollbar) && (recyclerView.computeVerticalScrollRange()
                                ...
                                mScrollbarAnimator = Utility.showScrollbar(mScrollbar, PickImage.this);
                            }
                        }
                        break;
    ...
    private OnSelectionListener onSelectionListener = new OnSelectionListener() {
        ...
        public void onLongClick(Img img, View view, int position) {
            if (options.getCount() > 1) {
                Utility.vibe(PickImage.this, 50);
                LongSelection = true;
    ...
    public static void start(final Fragment context, final Options options) {
        PermUtil.checkForCamaraWritePermissions(context, new WorkFinish() {
            ...
            public void onWorkFinish(Boolean check) {
                Intent i = new Intent(context.getActivity(), PickImage.class);
    ...
    public static void start(final FragmentActivity context, final Options options) {
        PermUtil.checkForCamaraWritePermissions(context, new WorkFinish() {
            @Override
            public void onWorkFinish(Boolean check) {
                Intent i = new Intent(context, PickImage.class);
                i.putExtra(OPTIONS, options);
                context.startActivityForResult(i, options.getRequestCode());
            }
        });
    ...
    private void initialize() {
        ...
        status_bar_height = Utility.getStatusBarSizePort(PickImage.this);
        ...
        camera.setLifecycleOwner(PickImage.this);
        ...
        camera.addCameraListener(new CameraListener() {
            ...
            public void onPictureTaken(PictureResult result) {
                ...
                result.toFile(photo, new FileCallback() {
                    ...
                    public void onFileReady(@Nullable File photo) {
                        ...
                        selectionList.add(img);
                        Utility.scanPhoto(PickImage.this, photo);
                        returnObjects();
                    }
                });
            }
            ...
            public void onVideoTaken(VideoResult result) {
                ...
                selectionList.add(img);
                Utility.scanPhoto(PickImage.this, result.getFile());
                camera.setMode(Mode.PICTURE);
                returnObjects();
            }
        ...
        TOPBAR_HEIGHT = Utility.convertDpToPixel(56, PickImage.this);
    ...
    private void updateImages() {
        ...
        Cursor cursor = Utility.getImageVideoCursor(PickImage.this, options.isExcludeVideos());
        if (cursor == null) {
            return;
        }
        ...
        for (int i = 0; i < limit; i++) {
            ...
            String dateDifference = Utility.getDateDifference(PickImage.this, calendar);
        ...
        imageVideoFetcher = new ImageVideoFetcher(PickImage.this) {
            @Override
        ...
        imageVideoFetcher.execute(Utility.getImageVideoCursor(PickImage.this, options.isExcludeVideos()));
        cursor.close();
    ...
    private void setBottomSheetBehavior() {
        ...
        mBottomSheetBehavior.setBottomSheetCallback(new BottomSheetBehavior.BottomSheetCallback() {
            ...
            public void onSlide(@NonNull View bottomSheet, float slideOffset) {
                Utility.manipulateVisibility(PickImage.this, slideOffset, findViewById(R.id.arrow_up),
                        instantRecyclerView, recyclerView, status_bar_bg,
                        topbar, bottomButtons, sendButton, LongSelection);
                if (slideOffset == 1) {
                    Utility.showScrollbar(mScrollbar, PickImage.this);
