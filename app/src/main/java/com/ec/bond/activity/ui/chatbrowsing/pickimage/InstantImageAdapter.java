...
public class InstantImageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == MainImageAdapter.HEADER) {
            ...
            return new InstantImageAdapter.HolderNone(view);
        } else {
            View view = LayoutInflater.from(parent.getContext()).
                    inflate(R.layout.inital_image, parent, false);
            return new InstantImageAdapter.Holder(view);
        }
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        Img image = list.get(position);
        if (holder instanceof InstantImageAdapter.Holder) {
            InstantImageAdapter.Holder imageHolder = (InstantImageAdapter.Holder) holder;
            ...
            InstantImageAdapter.HolderNone noneHolder = (InstantImageAdapter.HolderNone) holder;
