...
public class MainImageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements HeaderItemDecoration.StickyHeaderInterface, SectionIndexer {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == HEADER) {
            return new MainImageAdapter.HeaderHolder(LayoutInflater.from(parent.getContext()).
                    inflate(R.layout.header_row, parent, false));
        } else {
            View view = LayoutInflater.from(parent.getContext()).
                    inflate(R.layout.main_image, parent, false);
            return new MainImageAdapter.Holder(view);
        }
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof MainImageAdapter.Holder) {
            MainImageAdapter.Holder imageHolder = (MainImageAdapter.Holder) holder;
        ...
        } else if (holder instanceof MainImageAdapter.HeaderHolder) {
            MainImageAdapter.HeaderHolder headerHolder = (MainImageAdapter.HeaderHolder) holder;
